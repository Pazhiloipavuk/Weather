...
interface WeatherService {
    ...
    fun getCurrentWeather(@Query("lat") lat: String, @Query("lon") lon: String): Single<CurrentWeatherResponse.Result>

    @GET("data/2.5/forecast?units=metric&appid=39b26bdba8d1595289b541b253197efc")
    fun getWeatherForecast(@Query("lat") lat: String, @Query("lon") lon: String): Single<WeatherForecastResponse.Result>
}